...
{bLCDBacklight = true;
	...
	displayLCDCenteredString(0, "Prometheus");
	displayLCDCenteredString(1, "LOADING");
	wait1Msec(2000);
	//displayLCDCenteredString(0, "Bilal Likes");
	//displayLCDCenteredString(1, "Cock");
	//wait1Msec(750);
	//displayLCDCenteredString(0, "Ready to");
	//displayLCDCenteredString(1, "Fuck shit up");
	//wait1Msec(500);
	...
	while (true)
	{
		...
		while (bIfiRobotDisabled)
		{
			...
			while (true)
			{
				...
				sprintf(batteryTwo, "%1.2f%c", SensorValue[BackUpBattery]/31.34/*280.0*/	, 'V');    //Build the value to be displayed
