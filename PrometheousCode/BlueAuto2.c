...
while(MoveDist(3, 40, 2000));
TurnDegree(-105, 50);
while(LineStatusMiddle()!=1){Move(2, 25);}
StopDrive();
...
TurnDegree(90, 40);
//**********************//
//LineStatusLeft()==1||LineStatusMiddle()==1||LineStatusRight()==1
while(LineStatusLeft()==0&&LineStatusMiddle()==0&&LineStatusRight()==0){Move(2, 30);}
Break(150, 8);
stopArm();
